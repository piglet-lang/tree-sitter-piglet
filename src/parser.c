...
static TSCharacterRange sym__symbol2_character_set_1[] = {
  {'!', '!'}, {'$', '&'}, {'*', '+'}, {'-', ':'}, {'<', '?'}, {'A', 'Z'}, {'_', '_'}, {'a', 'z'},
  {'|', '|'}, {0xaa, 0xaa}, {0xb5, 0xb5}, {0xba, 0xba}, {0xc0, 0xd6}, {0xd8, 0xf6}, {0xf8, 0x2c1}, {0x2c6, 0x2d1},
  {0x2e0, 0x2e4}, {0x2ec, 0x2ec}, {0x2ee, 0x2ee}, {0x370, 0x374}, {0x376, 0x377}, {0x37a, 0x37d}, {0x37f, 0x37f}, {0x386, 0x386},
  {0x388, 0x38a}, {0x38c, 0x38c}, {0x38e, 0x3a1}, {0x3a3, 0x3f5}, {0x3f7, 0x481}, {0x48a, 0x52f}, {0x531, 0x556}, {0x559, 0x559},
...
static TSCharacterRange sym_prefix_name_character_set_1[] = {
  {'!', '!'}, {'$', '&'}, {'*', '+'}, {'-', '/'}, {':', ':'}, {'<', '?'}, {'A', 'Z'}, {'_', '_'},
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_prefix_name_character_set_1, 437, lookahead)) ADVANCE(26);
      END_STATE();
    case 1:
    ...
    case 6:
      ...
      if (set_contains(sym_keyword_character_set_1, 436, lookahead)) ADVANCE(37);
      END_STATE();
    case 7:
      if (lookahead == ':') ADVANCE(6);
      if (set_contains(sym_prefix_name_character_set_1, 437, lookahead)) ADVANCE(15);
      END_STATE();
    case 8:
      if (lookahead == '_') ADVANCE(44);
      END_STATE();
    case 9:
      ...
      END_STATE();
    case 10:
      if (set_contains(sym_keyword_character_set_1, 436, lookahead)) ADVANCE(27);
      END_STATE();
    case 11:
      if (set_contains(sym_keyword_character_set_1, 436, lookahead)) ADVANCE(28);
      END_STATE();
    case 12:
      if (set_contains(sym_keyword_character_set_1, 436, lookahead)) ADVANCE(16);
      END_STATE();
    case 13:
    ...
    case 16:
      ...
      if (set_contains(sym_keyword_character_set_2, 436, lookahead)) ADVANCE(16);
      END_STATE();
    case 17:
    ...
    case 26:
      ACCEPT_TOKEN(sym__symbol1);
      if (lookahead == ':') ADVANCE(10);
      if (set_contains(sym__symbol2_character_set_1, 436, lookahead)) ADVANCE(26);
      END_STATE();
    case 27:
      ACCEPT_TOKEN(sym__symbol2);
      if (lookahead == ':') ADVANCE(11);
      if (set_contains(sym__symbol2_character_set_1, 436, lookahead)) ADVANCE(27);
      END_STATE();
    case 28:
      ACCEPT_TOKEN(sym__symbol3);
      if (set_contains(sym_keyword_character_set_2, 436, lookahead)) ADVANCE(28);
      END_STATE();
    case 29:
    ...
    case 36:
      ...
      if (set_contains(sym_keyword_character_set_2, 436, lookahead)) ADVANCE(37);
      END_STATE();
    case 37:
      ACCEPT_TOKEN(sym_prefix_name);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(37);
